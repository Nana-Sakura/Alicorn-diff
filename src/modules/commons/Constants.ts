...
// They are very important for already installed LibearXLs!

export const LibearXL_VERSION_TYPE = "LibearXL";
export const MOJANG_USER_TYPE = "mojang";
export const LAUNCHER_NAME = "LibearXL";
export const LAUNCHER_VERSION = pkg.appVersion;
export const FILE_SEPARATOR = path.delimiter;
export const SPACE = " ";
export const LibearXL_SEPARATOR = "\u2764\u2764";
export const PROCESS_END_GATE = "END";
export const PROCESS_LOG_GATE = "LOG";
// Stands for 'LibearXL Data'
export const LibearXL_DATA_SUFFIX = ".ald";
// Stands for 'LibearXL Pinkie Promise'
export const LibearXL_ENCRYPTED_DATA_SUFFIX = ".alpp";
...
// MD5 of the following text (excluding quotes): "The developer of LibearXL Launcher is really a cute filly!"
