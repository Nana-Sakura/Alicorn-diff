...
import { LibearXL_DATA_SUFFIX } from "../commons/Constants";
...
const GDT_NAME = "global-container-descriptor" + LibearXL_DATA_SUFFIX;
let GlobalMountDescriptorTable: Map<string, boolean> = new Map();
const GMT_NAME = "global-mount-descriptor" + LibearXL_DATA_SUFFIX;
