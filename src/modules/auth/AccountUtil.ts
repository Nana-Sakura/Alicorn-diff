...
import { LibearXL_ENCRYPTED_DATA_SUFFIX } from "../commons/Constants";
...
export async function saveAccount(a: Account): Promise<boolean> {
    try {
        const fName = a.getAccountIdentifier() + LibearXL_ENCRYPTED_DATA_SUFFIX;
        await saveData(
