...
// LibearXL NEVER intends to support CF modpacks, while it's a popular function, I'll just prove it's easy...
// LibearXL has better support for Install.json and CAN run with OFFICIAL launcher!
