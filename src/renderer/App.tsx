...
import { expose } from "../modules/botbear/FTable";
...
import { Botbear } from "./linkage/Botbear";
...
import { LibearXLTheme } from "./Stylex";
...
const useStyles = makeStyles((theme: LibearXLTheme) => ({
    root: {
        flexGrow: 1,
        width: "100%",
...
function Routes(): JSX.Element {
    return (
        <Container>
            ...
            <Route path={"/Botbear"} component={Botbear} />
        ...
        <AppBar enableColorOnDark>
            <Toolbar>
                ...
                >
                    ...
                    <Tooltip
                        title={
                            <Typography className={"smtxt"}>{tr("MainMenu.Max")}</Typography>
                        }
                    >
                        <IconButton
                            id={"hotbar_max"}
...
async function maxApp(): Promise<void> {
...
const BETAS = ["ServerList", "Botbear", "Cadance", "DMCenter"];
