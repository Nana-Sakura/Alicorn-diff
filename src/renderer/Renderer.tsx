...
import { initBotbear } from "../modules/botbear/Driver";
import {
    getBoolean,
    getNumber,
    getString,
...
try {
    ...
    console.log(`LibearXL ${pkg.appVersion} Renderer Process`);
    /* Annie K Rarity
    ...
    */
    console.log("%cFrom Neila", "color:#1e9fff;");
    console.log(
        "%cNeila is a boy - Libear.",
        "color:#1e9fff;"
    );
    ...
    console.log(
        "LibearXL Copyright (C) 2021-2022 Neila"
    );
    console.log(
    ...
    void (async () => {
        ...
        console.log("This LibearXL has super cow powers.");
        bindSuperCowPower();
        console.log(
...
function flushColors(): void {
    ...
    let e: HTMLStyleElement | null = document.createElement("style");
    e.innerText =
        `html {background-color:${getString("theme.secondary.light") || "#" + getTheme()[3]
        }; font-family:${FONT_FAMILY};} a {color:${getString("theme.primary.main") || "#" + getTheme()[0]
        } !important;} ` +
        (isBgDark()
            ? `input, label {color:${getString("theme.primary.main") || "#" + getTheme()[0]
            } !important;} fieldset {border-color:${getString("theme.primary.main") || "#" + getTheme()[0]
            } !important;} div[role="radiogroup"] > label > span > span > div > svg, input[type="checkbox"] + svg, .MuiFormControlLabel-label .MuiInputBase-input {color: ${getString("theme.primary.main") || "#" + getTheme()[0]
            } !important;}`
            : "");
    // Set background
...
function setThemeParams(
    ...
    LibearXL_DEFAULT_THEME_LIGHT = createTheme({
        palette: {
            mode: "light",
            primary: {
                main: primaryMain,
    ...
    LibearXL_DEFAULT_THEME_DARK = createTheme({
        palette: {
            mode: "dark",
            primary: {
                main: primaryMain,
...
export let LibearXL_DEFAULT_THEME_DARK: Theme;
export let LibearXL_DEFAULT_THEME_LIGHT: Theme;
...
function RendererBootstrap(): JSX.Element {
    ...
    return (
        ...
        >
            <InstructionProvider>
                <ThemeProvider theme={LibearXL_DEFAULT_THEME_DARK}>
                    <HashRouter>
                        <App />
                    </HashRouter>
                    ...
                    <Typography
                        ...
                        color={"primary"}
                    >
                        {"LibearXL JE " + pkg.appVersion + " #" + pkg.updatorVersion}
                    </Typography>
                    <div
                        style={{
                            position: "fixed",
