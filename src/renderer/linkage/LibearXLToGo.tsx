// Linkage with LibearXL ToGo (https://github.com/Andy-K-Sparklight/LibearXLToGo)
...
// ToGo will place a hook file at ~/LibearXL-to-go-hook
const HOOK_NAME = "LibearXL-to-go-hook";
